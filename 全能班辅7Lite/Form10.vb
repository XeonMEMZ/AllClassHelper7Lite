...
Public Class Form10
    ...
    Private Sub Form10_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Width = 113
        bg = My.Computer.FileSystem.ReadAllText("themes\" & theme & "\f10color.txt")
        Me.Location = New Point(My.Computer.Screen.Bounds.Size.Width - Me.Width, Form2.Height * 8)
        speed = 0
