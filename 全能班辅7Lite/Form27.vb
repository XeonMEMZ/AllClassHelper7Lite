...
Public Class Form27
    ...
    Public Sub bcsjb()
        ...
        If RadioButton3.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "1", False)
        ElseIf RadioButton4.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "2", False)
        ElseIf RadioButton5.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "3", False)
        ElseIf RadioButton6.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "4", False)
        ElseIf RadioButton7.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "5", False)
        ElseIf RadioButton8.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "6", False)
        ElseIf RadioButton9.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "7", False)
        ElseIf RadioButton10.Checked = True Then
            My.Computer.FileSystem.WriteAllText("data\tss.txt", "0", False)
        End If
        bc = True
    End Sub
