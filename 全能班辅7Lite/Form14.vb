...
Public Class Form14
    ...
    Private Sub Form14_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Width = 113
        bg = My.Computer.FileSystem.ReadAllText("themes\" & theme & "\f14color.txt")
        Me.Location = New Point(My.Computer.Screen.Bounds.Size.Width - Me.Width, Form2.Height * 12)
        speed = 0
