...
Public Class Form8
    ...
    Private Sub Form8_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Width = 113
        bg = My.Computer.FileSystem.ReadAllText("themes\" & theme & "\f8color.txt")
        Me.Location = New Point(My.Computer.Screen.Bounds.Size.Width - Me.Width, Form2.Height * 6)
        speed = 0
