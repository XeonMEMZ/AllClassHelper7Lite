...
Public Class Form3
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Width = 113
        bg = My.Computer.FileSystem.ReadAllText("themes\" & theme & "\f3color.txt")
        Me.Location = New Point(My.Computer.Screen.Bounds.Size.Width - Me.Width, Form2.Height)
        speed = 0
